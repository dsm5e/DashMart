        ...
        NavigationView {
            ScrollView {
                    Text("""
                     ...
                     These Terms & Conditions apply to the “Buyer Protection Money Back Guarantee” or “Basic Buyer Protection” in DashMart (the “Buyer Protection”).
                     
                     1. Promoter: the contracting party determined in accordance with the section “1.1 Contracting Party” of the Alibaba.com Transaction Services Agreement (“DashMart” or the “Promoter”).
                     
                     2. Eligible Member: You must be a registered member of DashMart with a valid account and have successfully made and completed a purchase of goods and/or services on DashMart.
                     
                     3. Buyer Protection Period: the number of days (appearing/confirmed on the product listing page at the time when the Eligible Member completed the purchase from the seller on DashMart) which the seller guarantees the Eligible Member that it would receive the goods and/or services ordered from the seller, start counting from the day the Eligible Member completes such purchase on DashMart.
                     
                     4. Rules:
                     a. If the Eligible Member does not receive the goods and/or services within Buyer Protection Period or receives goods and/or services that are sub-standard in its view, the Eligible Member may initiate the dispute procedures as stipulated in DashMart under “Disputes and Reports” to report this incident (“Dispute Procedures”) to DashMart.
                     
                     b. During the Dispute Procedures, DashMart will investigate this incident considering (but not limited to) the following factors:
                     ...
                     c. DashMart is not responsible for any late, lost, delayed, incomplete, illegible, misdirected or undeliverable entries, responses, or other correspondence, whether by e-mail or otherwise.
                     
                     d. The eligibility to this Buyer Protection shall be determined by DashMart at their sole discretion based on the Promoter’s record. If there is any discrepancy between the record of transaction held by you and that held by the Promoter, the Promoter’s record shall be conclusive and binding on you.
                     
                     e. DashMart reserves the right to amend these Official Rules without prior notice. In the event of disputes, the decision of the Promoter shall be final and binding.
                     
                     f. DashMart reserves the right and absolute discretion to cancel or revoke anyone’s right to participate in this Buyer Protection.
                     
                     6. Force Majeure: Under no circumstances shall DashMart be held liable to the Eligible Member for this Buyer Protection or any rights under these Official Rules due to or resulting directly or indirectly from acts of nature, forces or causes beyond the reasonable control of DashMart or the relevant seller, including without limitation, Internet failures, computer, telecommunications or any other equipment failures, electrical power failures, strikes, labor disputes, riots, insurrections, civil disturbances, shortages of labor or materials, fires, flood, storms, explosions, acts of God, war, governmental actions, orders of domestic or foreign courts or tribunals, or non-performance of third parties or any suspension or disruption of transportation or business operation (including but not limited to delays or disruption of the resumption of work or operation ordered by any government agency) in the event of a national or regional spread of epidemic or pandemic.
                     ...
                     b. In the event that any of the terms under these Official Rules conflict with rules and/or any such related information displayed elsewhere on DashMart, the terms under these Official Rules shall prevail. The Alibaba.com Transaction Services Agreement shall prevail and complement these Rules.
